			...
			if(status > 0){			
				...
				if(cbstmt.getDouble("fromBalance") > 0){
					...
					if(((addTransation(new Transaction(Long.parseLong(transactionId), 
						...
						&& (SMSSender.toSenderBank(fromName, bank, fID.toString(), 
									date, bank+"-INTERNAL", transactionId, 
									amount, fromBalance, fromPhoneNumber) == 1)
							
						&& (SMSSender.toReceiverBank(toName, bank, tID.toString(),
			...
			if(status > 0){			
				...
				if(cbstmt.getDouble("fromBalance") > 0){
					...
					if(((addTransation(new Transaction(Long.parseLong(transactionId), 
						...
						&& (SMSSender.toSenderBank(fromName, fromBank, fID.toString(), 
									date, "EXTERNAL("+fromBank+"-"+toBank+")", transactionId, 
									amount, fromBalance, fromPhoneNumber) == 1)
							
						&& (SMSSender.toReceiverBank(toName, toBank, tID.toString(),
			...
			if(status > 0){			
				...
				if(cbstmt.getDouble("fromBalance") > 0){
					...
					if(((addTransation(new Transaction(Long.parseLong(transactionId), 
						...
						&& (SMSSender.toReceiverBank(toName, mobileName, toMobile,
			...
			if(status > 0){			
				...
				if(cbstmt.getDouble("fromBalance") > 0){
					...
					if(((addTransationMobile(new Transaction(Long.parseLong(transactionId), 
						...
						&& (SMSSender.toSenderBank(fromName, mobileName, fromPhoneNumber, 
									date, "MobileToBank("+mobileName+"-"+toBank+")", transactionId, 
									amount, fromBalance, fromPhoneNumber) == 1)
							
						&& (SMSSender.toReceiverBank(toName, toBank, toNumber,
